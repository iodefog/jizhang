...
@property (nonatomic, strong) NSArray <SSJFundingParentmodel*> *sassetsFundsWithOutLoan;

@property (nonatomic, strong) NSArray <SSJFundingParentmodel*> *liabilitiesFundsWithOutLoan;

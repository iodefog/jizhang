...
+ (void)jumpToImportViewController:(SSJBaseViewController *)controller {
    SSJBookKeepingHomeViewController *bookKeepingVC = [[SSJBookKeepingHomeViewController alloc] initWithNibName:nil bundle:nil];
    SSJDataImportViewController *importVc = [[SSJDataImportViewController alloc] initWithNibName:nil bundle:nil];
    SSJNavigationController *bookKeepingNavi = [[SSJNavigationController alloc] init];
    [bookKeepingNavi setViewControllers:@[bookKeepingVC,importVc]];
    bookKeepingNavi.tabBarItem.title = @"记账";

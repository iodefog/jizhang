...
WCDB_SYNTHESIZE_COLUMN_DEFAULT(SSJLoanTable, interestType, "INTERESTTYPE", 0)
WCDB_SYNTHESIZE_COLUMN(SSJLoanTable, writeDate, "CWRITEDATE")
WCDB_SYNTHESIZE_COLUMN(SSJLoanTable, operatorType, "OPERATORTYPE")
WCDB_SYNTHESIZE_COLUMN(SSJLoanTable, version, "IVERSION")

WCDB_PRIMARY(SSJLoanTable, loanId)

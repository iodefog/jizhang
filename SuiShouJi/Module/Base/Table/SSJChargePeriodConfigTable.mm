...
WCDB_SYNTHESIZE_COLUMN(SSJChargePeriodConfigTable, billDate, "CBILLDATE")
WCDB_SYNTHESIZE_COLUMN(SSJChargePeriodConfigTable, state, "ISTATE")
...
WCDB_SYNTHESIZE_COLUMN(SSJChargePeriodConfigTable, memberIds, "CMEMBERIDS")
WCDB_SYNTHESIZE_COLUMN(SSJChargePeriodConfigTable, billDateEnd, "CBILLDATEEND")

...
{
    self.textLengthLabel.text = [NSString stringWithFormat:@"剩余%u个字",self.maxLength - textView.text.length];
...
-(void)setOriginalText:(NSString *)originalText{
    ...
    self.textLengthLabel.text = [NSString stringWithFormat:@"剩余%u个字",self.maxLength - _originalText.length];
    [self.textLengthLabel sizeToFit];
}

...
-(UILabel*)expenditureLabel{
    if (!_expenditureLabel) {
        ...
        _expenditureLabel.font = [UIFont ssj_pingFangRegularFontOfSize:SSJ_FONT_SIZE_4];
...
- (void)updateCellAppearanceAfterThemeChanged {
    ...
    self.categoryImageButton.backgroundColor = [UIColor ssj_colorWithHex:SSJ_CURRENT_THEME.borderColor];
}

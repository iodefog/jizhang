...
-(void)saveButtonClicked:(id)sender{
    ...
    if([db intForQuery:@"SELECT COUNT(1) FROM BK_FUND_INFO WHERE CACCTNAME = ? AND CFUNDID <> ? AND CUSERID = ?",_nameTextField.text,self.item.fundingID,SSJUSERID()] > 0I\=-=0987      Q11Q    A nm/?.,mnbvcvbnm){

...
+ (BOOL)handleOpenURL:(NSURL *)url{
    ...
    NSDictionary *parameterDic = [self getURLParameters:urlStr];
    
    NSString *inviteCode = [parameterDic objectForKey:@"code"];
    ...
    if (SSJIsUserLogined()) {
        ...
        [SSJVisibalController().navigationController pushViewController:codeInviteVc animated:YES];
    } else {
        SSJInviteCodeJoinViewController *codeInviteVc = [[SSJInviteCodeJoinViewController alloc] init];
        codeInviteVc.inviteCode = inviteCode;

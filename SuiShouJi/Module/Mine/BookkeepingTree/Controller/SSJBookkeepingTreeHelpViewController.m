...
- (UIView *)titleView {
    if (!_titleView) {
        ...
        titleLab.font = [UIFont ssj_pingFangRegularFontOfSize:SSJ_FONT_SIZE_7];
...
- (UIView *)sectionView {
    if (!_sectionView) {
        ...
        levelLab.font = [UIFont ssj_pingFangRegularFontOfSize:SSJ_FONT_SIZE_5];
        ...
        daysLab.font = [UIFont ssj_pingFangRegularFontOfSize:SSJ_FONT_SIZE_5];

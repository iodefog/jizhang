//
//  SSJChargeCircleBooksSelectView.m
//  SuiShouJi
//
...
@interface SSJChargeCircleBooksSelectView()<UITableViewDelegate,UITableViewDataSource>
...
@property (nonatomic, strong) NSString *selectBooksId;

@end

@implementation SSJChargeCircleBooksSelectView
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    SSJBooksTypeItem *item = [self.booksArr ssj_safeObjectAtIndex:indexPath.row];
    
    if (self.didSelectBooksItem) {
        self.didSelectBooksItem(item);
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.accessoryView = [item.booksId isEqualToString:self.selectBooksId] ? self.accessoryView : nil;
...
- (void)setBooksArr:(NSArray *)booksArr {
    _booksArr = booksArr;
    [self.tableView reloadData];
}

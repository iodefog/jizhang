...
- (UITextField *)textField
{
    if (!_textField) {
        ...
        _textField.font = SSJ_PingFang_REGULAR_FONT_SIZE(SSJ_FONT_SIZE_4);
...
- (SSJCustomTextView *)textView
{
    if (!_textView) {
        ...
        _textView.font = SSJ_PingFang_REGULAR_FONT_SIZE(SSJ_FONT_SIZE_4);
...
- (UILabel *)fanKuiLabel
{
    if (!_fanKuiLabel) {
        ...
        _fanKuiLabel.font = SSJ_PingFang_REGULAR_FONT_SIZE(SSJ_FONT_SIZE_4);

...
+ (NSError *)updateBillTypeTableWithDatabase:(FMDatabase *)db {
    ...
    if (![db executeUpdate:@"delete from bk_bill_type where icustom = 1"]) {
        return [db lastError];
    }
...
+ (NSArray *)insertSqlArray {
    return  @[@"INSERT INTO `BK_BILL_TYPE` VALUES ('1000','餐饮',1,NULL,'bt_food','#ee9d29',1,0,NULL,2,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1001','烟酒茶',1,NULL,'bt_tobacco','#4f8ed5',1,0,NULL,12,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1002','交通',1,NULL,'bt_traffic','#379647',1,0,NULL,3,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1003','购物',1,NULL,'bt_shopping','#d56335',1,0,NULL,4,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1004','娱乐',1,NULL,'bt_entertainment','#647ede',1,0,NULL,16,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1005','投资亏损',1,NULL,'bt_deficit','#408637',1,0,NULL,22,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1006','生活服务',1,NULL,'bt_service','#d13e3e',0,0,NULL,24,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1007','话费',1,NULL,'bt_recharge','#465a9b',1,0,NULL,20,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1008','医药',1,NULL,'bt_medicine','#f25c5c',0,0,NULL,42,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1009','住房',1,NULL,'bt_house','#b05c5c',1,0,NULL,18,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1010','水电煤',1,NULL,'bt_water','#a66e16',1,0,NULL,19,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1011','食材',1,NULL,'bt_shicai','#f86e3c',0,0,NULL,25,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1012','水果',1,NULL,'bt_fruit','#66b34a',1,0,NULL,8,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1013','零食',1,NULL,'bt_snack','#d969ba',1,0,NULL,9,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1014','汽车',1,NULL,'bt_car','#83aa3f',0,0,NULL,36,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1015','家居',1,NULL,'bt_furniture','#2793cb',0,0,NULL,33,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1016','服饰',1,NULL,'bt_clothes','#ff8bc4',1,0,NULL,11,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1017','美容美发',1,NULL,'bt_meirong','#fc7f58',0,0,NULL,43,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1018','旅行',1,NULL,'bt_tourism','#78a354',0,0,NULL,26,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1019','礼金',1,NULL,'bt_gift','#c62f2f',1,0,NULL,23,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1020','家用',1,NULL,'bt_jiayong','#be7330',1,0,NULL,21,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1021','育婴',1,NULL,'bt_baby','#d96cb4',1,0,NULL,13,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1022','教育',1,NULL,'bt_education','#278f38',0,0,NULL,45,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1023','健身',1,NULL,'bt_sport','#07a1c2',0,0,NULL,39,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1024','结婚',1,NULL,'bt_marry','#e15534',0,0,NULL,46,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1025','维修',1,NULL,'bt_repair','#478e98',0,0,NULL,47,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1026','养宠',1,NULL,'bt_pet','#ab9444',0,0,NULL,38,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1027','清洁',1,NULL,'bt_clean','#359dc8',0,0,NULL,48,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1028','数码',1,NULL,'bt_digital','#2c53ab',0,0,NULL,34,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1029','邮费',1,NULL,'bt_youfei','#6b883c',0,0,NULL,32,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1030','利息',1,NULL,'bt_interest','#408637',0,0,NULL,53,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1031','还钱',1,NULL,'bt_huankuan','#7b529b',0,0,NULL,31,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1032','交税',1,NULL,'bt_jiaoshui','#e16b6b',0,0,NULL,54,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1033','其他',1,NULL,'bt_others','#626262',0,0,NULL,56,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2001','工资',0,NULL,'bt_wages','#e1861b',1,0,NULL,2,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2002','奖金',0,NULL,'bt_bouns','#66b34a',1,0,NULL,3,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2003','福利',0,NULL,'bt_fuli','#2bbeb2',1,0,NULL,4,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2004','投资收益',0,NULL,'bt_invest','#d44f4f',1,0,NULL,5,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2005','收红包',0,NULL,'bt_hongbao','#e15534',1,0,NULL,6,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2006','兼职',0,NULL,'bt_jianzhi','#78a543',1,0,NULL,7,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2007','生活费',0,NULL,'bt_shenghuofei','#be7330',1,0,NULL,8,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2008','报销',0,NULL,'bt_baoxiao','#6691e9',1,0,NULL,9,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2009','退款',0,NULL,'bt_tuikuan','#68b58a',1,0,NULL,10,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2010','公积金',0,NULL,'bt_gongjijin','#766bc8',1,0,NULL,13,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2011','社保金',0,NULL,'bt_shebao','#359dc8',1,0,NULL,14,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2012','礼金',0,NULL,'bt_gift','#c62f2f',1,0,NULL,11,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2013','收款',0,NULL,'bt_shouzhai','#63671a',0,0,NULL,15,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2014','贷款',0,NULL,'bt_daikuan','#b47100',0,0,NULL,16,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2015','营业',0,NULL,'bt_yingye','#00a2f2',0,0,NULL,17,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2017','其他',0,NULL,'bt_others','#626262',0,0,NULL,25,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1','平账收入',0,NULL,'bt_pignzhangshouru','#9382ad',2,0,NULL,NULL,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2','平账支出',1,NULL,'bt_pingzhangzhichu','#5889c5',2,0,NULL,NULL,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('3','转入',0,NULL,'bt_zhuanchu','#993f84',2,0,NULL,NULL,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('4','转出',1,NULL,'bt_zhuanru','#4a8984',2,0,NULL,NULL,0)",
              ...
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1043','酒店',1,'','bt_jiudian','#766bc8',0,0,NULL,28,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1044','机票',1,'','bt_jipiao','#3c81ce',0,0,NULL,29,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1045','生意',1,'','bt_shengyi','#ad492b',0,0,NULL,30,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1046','电器',1,'','bt_dianqi','#e16b6b',0,0,NULL,35,0)",
              ...
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1049','游园',1,'','bt_youyuan','#6691e9',0,0,NULL,41,0)",
              ...
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1052','手续费',1,'','bt_shouxufei','#d4ba28',0,0,NULL,51,0)",
              ...
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1041','出差',1,NULL,'bt_chuchai','#426ab2',0,0,NULL,27,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('1057','保姆',1,NULL,'bt_baomu','#b3852b',0,0,NULL,49,0)",
              @"INSERT INTO `BK_BILL_TYPE` VALUES ('2016','意外收入',0,NULL,'bt_yiwai','#004cb6',0,0,NULL,18,0)",
